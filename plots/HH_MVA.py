...
#                                      "nEventsMin=200",
                                      "MaxDepth=4",
                                      "BoostType=AdaBoost",
                                      "AdaBoostBeta=0.15", # 0.1 -> 0.05
                                      "SeparationType=GiniIndex",
                                      "nCuts=80" # 20 -> 70 -> 100
                                     ]) )

    if "BDTBoost1" in methods:
...
def main():
    ...
    allVars = [ "Njets20","Nbjets30",
                ...
                "M_jj", "M_j1l",
                "MT_lnu","MT_jjlnu" ]
                # Mbl better discrimant than Mblnu
