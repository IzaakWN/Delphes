...
#              ]
    ...
    if opts.test:
        ...
        configs = [
                    ...
                    configuration("everything12MN", allVars12MN, 1),
...
#                    configuration("better20",     betterVars, 1),
                    ...
                    configuration("everything12MCleanUp", allVars12M, 2),
                    configuration("everything12MNCleanUp", allVars12MN, 2),
