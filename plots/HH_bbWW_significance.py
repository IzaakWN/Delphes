...
# cross section
sigma_S = 40 * 0.027 # fb = sigma_HH * BR_
sigma_B = 984500 # fb
...
def punzi(stage):
    ...
    for name in names:
        ...
        hist_B = file_tt.Get(stage+name) # BG: tt -> bbWW
