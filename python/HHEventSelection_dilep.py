...
categoryNames = [ "GenLevel_dilep", "GenLevelCuts_dilep", "Selection_dilep", "CleanUp_dilep", "LooseSelection_dilep",
                  "GenLevel", "GenLevelCuts","Cuts", "CleanUp", "LooseSelection" ]
...
def isInCategory(category, categoryData):
    ...
    if category == 4:
        ...
        #      > GenLevel          > loose selection  > clean-up
